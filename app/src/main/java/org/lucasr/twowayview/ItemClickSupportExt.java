...
public class ItemClickSupportExt {
    /**
    ...
    private ItemClickSupportExt(RecyclerView recyclerView) {
    ...
    public static ItemClickSupportExt addTo(RecyclerView recyclerView) {
        ItemClickSupportExt itemClickSupport = from(recyclerView);
        if (itemClickSupport == null) {
            itemClickSupport = new ItemClickSupportExt(recyclerView);
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        final ItemClickSupportExt itemClickSupport = from(recyclerView);
        if (itemClickSupport == null) {
            // TODO: Log warning
            return;
        }
    ...
    public static ItemClickSupportExt from(RecyclerView recyclerView) {
        if (recyclerView == null) {
            return null;
        }

        return (ItemClickSupportExt) recyclerView.getTag(R.id.twowayview_item_click_support);
    }

    private class TouchListener extends ClickItemTouchListenerExt {
