...
abstract class ClickItemTouchListenerExt implements OnItemTouchListener {
    private static final String LOGTAG = "ClickItemTouchListenerExt";

    private final GestureDetectorCompat mGestureDetector;

    ClickItemTouchListenerExt(RecyclerView hostView) {
