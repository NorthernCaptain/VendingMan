 ...
 * Taken from here: http://forum.xda-developers.com/showthread.php?t=1363906
 * Originally developed by Fr4gg0r
 */
public class PreferenceListFragment extends ListFragment
{
     ...
     */
    protected PreferenceManager onCreatePreferenceManager()
    {
        try
        {
